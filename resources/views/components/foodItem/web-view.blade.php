            ...
            <div class="col-lg-12">
                <div class="tab-content main" id="foodTabContent">
                    <div class="tab-pane fade show active " id="pally" role="tabpanel" aria-labelledby="pally-tab">
                        <h6 class="inner-head">{{$shop->count()}} Available Deals</h6>
                        <div class="">
                            <div class="row">
                                @foreach(range(0,$shop->count()-1) as $item)
                                    ...
                                    <div class="pally-inner ">
                                        <div class="products-img-wrapper  mb-3 pointer">
                                            <a href="product_detail.html">
                                                ...
                                                <img class=" product-img mb-3" src="{{$shop[$item]->image_url}}" alt="Product-img1" loading="lazy">
                                            </a>
                                        </div>
                                        ...
                                        <div class="pally-content">
                                            ...
                                            <a href="#" class="red-bg"><span class="material-icons-outlined">
                                                    arrow_right_alt
                                                </span>{{$shop[$item]->percentage}}% | <span class="clr-gr">{{$shop[$item]->season}} Season</span></a>
